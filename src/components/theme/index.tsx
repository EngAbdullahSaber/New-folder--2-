...
import type {} from '@mui/material/themeCssVarsAugmentation' // ❗ Do not remove (required for prod build)
import type {} from '@mui/lab/themeAugmentation' // ❗ Do not remove (required for prod build)
...
const CustomThemeProvider = (props: Props) => {
  ...
  return (
    <AppRouterCacheProvider
      key={`${settings.skin}-${settings.primaryColor}`}
      options={{
        prepend: true,
        ...(direction === 'rtl' && {
          key: 'rtl',
