...
const ChangePasswordVerification = ({ mode }: { mode: Mode }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch(`${apiUrl}/aut/change-password`, {
        method: 'POST',
        headers: {
  ...
  const verifyCode = async () => {
    try {
      ...
      const response = await fetch(`${apiUrl}/aut/users/verify`, {
        ...
        body: JSON.stringify({ sms_verify_code: otp })
      })
              ...
              {activeStep === 0 && (
                <>
                  ...
                  <Form noValidate autoComplete='off' className='flex flex-col gap-5'>
                    ...
                    <Button fullWidth variant='contained' onClick={handleSubmit} disabled={!oldPassword || loading}>
              ...
              {activeStep === 2 && (
                <>
                  <div className='flex flex-col gap-1'>
                    ...
                    <Typography>الرجاء إدخال كلمة المرور الجديدة</Typography>
                  </div>
