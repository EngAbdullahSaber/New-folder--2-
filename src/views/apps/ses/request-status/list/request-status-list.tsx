...
const RequestStatusList = ({ scope }: ComponentGeneralProps) => {
...
console.log('appSetting', appSetting?.internal_department_type_id)
  useEffect(() => {
  ...
  return (
    <ListComponent
      ...
      maxVisibleColumns={7}
      showOnlyOptions={['search', 'print', 'export', 'edit']}
      extraQueryParams={{ is_elected: '1' }}
    />
  )
}
