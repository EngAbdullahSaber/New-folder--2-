...
const OptionMenu = (props: OptionsMenuType & { onSelect?: (optionText: string) => void }) => {
  // Props
  const { tooltipProps, icon, iconClassName, options, leftAlignMenu, iconButtonProps, onSelect } = props
  ...
  const handleOptionClick = (value: any) => {
    if (value) if (value && onSelect) onSelect(value) // Ensure only strings are passed
    setOpen(false)
  }
