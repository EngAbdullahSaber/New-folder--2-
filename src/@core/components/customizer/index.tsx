...
const Customizer = ({ breakpoint = 'lg', dir = 'rtl', disableDirection = true }: CustomizerProps) => {
  // States
      ...
      >
        ...
        <div className={classnames('customizer-header flex items-center justify-between', styles.header)}>
          <div className='flex flex-col gap-2'>
            <h4 className={styles.customizerTitle}>أداة تخصيص القالب</h4>
            <p className={styles.customizerSubtitle}>تخصيص ومعاينة في الوقت الحقيقي</p>
          </div>
        ...
        >
          <div className={classnames('customizer-body flex flex-col', styles.customizerBody)}>
            <div className='theming-section flex flex-col gap-6'>
              <Chip variant='tonal' label='السمات' size='small' color='primary' className='self-start rounded-sm' />
              <div className='flex flex-col gap-2'>
              ...
              <div className='flex flex-col gap-2'>
                <p className='font-medium'>جلود</p>
            ...
            <div className='layout-section flex flex-col gap-6'>
              <Chip variant='tonal' label='تَخطِيط' size='small' color='primary' className='self-start rounded-sm' />
              <div className='flex flex-col gap-2'>
                <p className='font-medium'>القائمة (الملاحة)</p>
                <div className='flex items-center justify-between'>
                  <div className='flex flex-col items-start gap-0.5'>
                    <div
              ...
              <div className='flex flex-col gap-2'>
                <p className='font-medium'>محتوى</p>
                <div className='flex items-center gap-4'>
                  <div className='flex flex-col items-start gap-0.5'>
                    <div
              ...
              {!disableDirection && (
                <div className='flex flex-col gap-2'>
                  <p className='font-medium'>اتجاه</p>
                  <div className='flex items-center gap-4'>
