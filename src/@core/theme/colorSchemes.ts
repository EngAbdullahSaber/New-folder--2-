...
const colorSchemes = (skin: Skin): Theme['colorSchemes'] => {
  return {
    light: {
      palette: {
        primary: {
          main: '#1a73e8', // Google Blue/Professional
          light: '#4285f4',
          dark: '#174ea6',
        ...
        background: {
          default: '#fbfbfb',
          paper: skin === 'bordered' ? '#FFFFFF' : '#F7F7F9',
          paperChannel: skin === 'bordered' ? '255 255 255' : '247 247 249'
        },
        action: {
          active: `rgb(var(--mui-mainColorChannels-light) / 0.6)`,
          hover: `rgb(var(--mui-mainColorChannels-light) / 0.035)`,
    ...
    dark: {
      palette: {
        ...
        background: {
          default: '#30334E',
          paper: skin === 'bordered' ? '#30334E' : '#282A42',
          paperChannel: skin === 'bordered' ? '48 51 78' : '40 42 66'
        },
        action: {
          active: `rgb(var(--mui-mainColorChannels-dark) / 0.6)`,
          hover: `rgb(var(--mui-mainColorChannels-dark) / 0.035)`,
